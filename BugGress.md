...
- 当前部署包：`houyis-bow-1.0.5.jar`；1.0.6 已完成本地构建，尚未完成 Windows 替换。
...
| BG-008 | 多次快速射击后明显卡顿 | 每支高速箭独立发送拖尾粒子，落地箭又按原版约 60 秒持续堆积 | 1.0.6 | 本地构建与字节码验证通过，待完整实例性能验证 |
...
- Windows 哈希和完整实例 30 秒连续射击测试尚待本轮后续步骤完成。
